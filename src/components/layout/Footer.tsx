        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-2xl mx-auto text-center animate-fade-in-up">
            ...
            <div className="flex gap-3 max-w-md mx-auto">
              ...
              />
              <Button className="rounded-full px-8 shadow-glow hover:shadow-glow-lg hover:scale-105 transition-all duration-300" aria-label="Subscribe to newsletter">
                Subscribe
              </Button>
            </div>
          </div>
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="flex gap-3">
                <a href="https://www.instagram.com/_kalspire_/" target="_blank" rel="noreferrer">
                  <Button variant="outline" size="icon" className="rounded-full hover:bg-primary hover:text-primary-foreground hover:scale-110 hover:shadow-glow transition-all duration-300" aria-label="Follow us on Instagram">
                    <Instagram className="h-5 w-5" />
                  </Button>
                </a>
                <Button variant="outline" size="icon" className="rounded-full hover:bg-primary hover:text-primary-foreground hover:scale-110 hover:shadow-glow transition-all duration-300" aria-label="Follow us on Facebook">
                  <Facebook className="h-5 w-5" />
                </Button>
                <Button variant="outline" size="icon" className="rounded-full hover:bg-primary hover:text-primary-foreground hover:scale-110 hover:shadow-glow transition-all duration-300" aria-label="Send us an email">
